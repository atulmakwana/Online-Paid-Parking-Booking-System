            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                ...
                <nav id="colorlib-main-menu" role="navigation">
                    <ul>
                        ...
                        <li class="colorlib-active"><a href="Owner_login.jsp">Owner</a></li>
            ...
            <div id="colorlib-main">
                <div class="colorlib-contact">
                    <div class="colorlib-narrow-content">
                        ...
                        <div class="row">
                            <center><h2>Owner Register</h2></center>
                            <br><br>
                            <div class="col-md-5">
                                <br><br><br><br>
                                <img src="images/nregister.jpg" width="400" height="500" />
                            </div>
                                    ...
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <form action="owner_reg" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="pspace" placeholder="Enter Your Parking area" required="required">
                                            </div>
                                            <div class="form-group">
