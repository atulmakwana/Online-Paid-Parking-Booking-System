                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-push-2">
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                        <form  action="Book_parking1.jsp" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nump" id="nump" required="required">
                                                
                                            </div>
                                            
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Enter Parking space name :</label>
                                                <select name="pspace" id="meeting" class="form-control" required="required">
                                    ...
                                    try {
                                        ResultSet rt = st.executeQuery("SELECT * FROM owner_reg");
                                        while (rt.next()) 
                                        {
                                            psp=rt.getString("pspace");
                                    %>
                                            
                                    <option><%=rt.getString("pspace")%></option>
