                        ...
                        <div class="row">
                            ...
                            <form  action="slot_booking.jsp" method="post">
                                ...
                                <%
                                    ...
                                    String psp = request.getParameter("pspace");
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 col-md-offset-1 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nump" class="form-control" value="<%=nump%>"readonly="">
                                            </div>
                                            <div class="form-group">
                                                &nbsp;&nbsp;<label>Parking space name :</label>
                                                <input type="text" name="psp" class="form-control" value="<%=psp%>"readonly="">
                                            </div>
                                            <div class="form-group">
